    ...
    <>
      ...
      <SectionWrapper className="bg-[#111111]" dark>
        <div className="text-center mb-6 sm:mb-10">
          ...
          <h2 className="font-gothic text-white" style={{ fontSize: 'var(--font-h2)', fontWeight: 300 }}>
      ...
      <SectionWrapper>
        <div className="text-center mb-6 sm:mb-10">
          ...
          <h2 className="font-gothic text-gray-900" style={{ fontSize: 'var(--font-h2)', fontWeight: 300 }}>
