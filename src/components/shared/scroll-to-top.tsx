    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className="fixed right-3 z-[900] flex h-12 w-12 items-center justify-center bg-brand-green-deep text-brand-on-green transition-colors hover:bg-brand-green-deep-hover sm:right-6"
          style={{
