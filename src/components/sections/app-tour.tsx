  ...
  return (
    ...
    >
      ...
      <div className={cn("lg:col-span-7", flip && "lg:order-1")}>
        <h3
          data-reveal
          className="t-h3 font-gothic text-white"
        >
          {title}
        </h3>
        <p
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
        ...
        >
          ...
          <h1
            data-reveal
            className="t-h1 font-gothic text-white"
          >
            Every screen that{" "}
        ...
        >
          ...
          <p className="mt-12 t-measure text-xs font-light leading-relaxed text-white/40">
